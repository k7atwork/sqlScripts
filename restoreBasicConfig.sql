...
SELECT * FROM HRINT..PS_SCH_DEFN_TBL WHERE SUBSTRING(RIGHT(SCHEDULE_ID, 5),1,3) <> '000'
INSERT INTO PS_SCH_DEFN_DTL
SELECT * FROM HRINT..PS_SCH_DEFN_DTL WHERE SUBSTRING(RIGHT(SCHEDULE_ID, 5),1,3) <> '000'
